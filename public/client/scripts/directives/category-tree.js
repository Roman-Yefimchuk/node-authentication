        ...
        function ($compile, $log, $rootScope, $http) {
            ...
            function loadNodeTemplate(callback) {
                if (NODE_TEMPLATE) {
                    ...
                    var request = $http.get('/public/client/views/directives/category-tree/category-tree-node-view.html');
            ...
            return {
                transclude: true,
                templateUrl: '/public/client/views/directives/category-tree/category-tree-view.html',
                scope: {
                    treeModel: '=',
                    onSelection: '&',
                    onLoading: '&',
                ...
                link: function (scope, element, attr) {
                    ...
                    function getTreeScope() {
                        ...
                        treeScope.$on('$destroy', function (event) {
                            rootNodes = {};
                            nodes = {};
                            $log.debug('categoryTree destroyed');
                        });
                    ...
                    scope.$on('categoryTree[' + treeId + ']:search', function (event, id, callback) {
                    ...
                    scope.$on('categoryTree[' + treeId + ']:insertRoot', function (event, item, callback) {
                        if (typeof callback == 'function') {
                    ...
                    scope.$watch('treeModel', function (treeModel) {
                        ...
                        if (treeModel && treeModel.length) {
                            ...
                            loadNodeTemplate(function () {
                                ...
                                $rootScope.$broadcast('categoryTree[' + treeId + ']:ready');
                            });
                        }
                    });
                }
